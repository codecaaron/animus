...
- [x] 7.3 Archive via `openspec archive fix-selector-rule-extraction` once Phases 1–5 are complete and the fresh-build re-audit shows the CloseButton + PatternC class of regressions resolved. (Initial attempt 2026-04-21 hit `jsx-system-prop-scanner MODIFIED failed for header` bug — bug was resolved in openspec by 2026-04-27 per Session 90 successful archive of `add-rust-dep-hygiene`. Re-attempted 2026-04-27.)
