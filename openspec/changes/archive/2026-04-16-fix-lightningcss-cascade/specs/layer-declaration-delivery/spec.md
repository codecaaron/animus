## NEW Capability: layer-declaration-delivery

The `@layer` cascade declaration is structural metadata that establishes layer ordering for the entire document. It must reach the browser intact and before any stylesheet content. The delivery mechanism varies by plugin host.
