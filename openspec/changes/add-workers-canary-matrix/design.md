...
| DEF-4 | Creation and Git connection of the three new remote Workers | deferred | 2.1 | All local build/assert/dry-run gates pass and `wrangler whoami` confirms the intended account | 2 reorientations \| 2026-07-16 |
